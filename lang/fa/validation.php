...
return [
    ...
    */
    ...
    'attributes'           => [
        ...
        'code'     => 'کد تخفیف',
        'work_area'     => 'حوزه کاری',
        'about_title'     => 'عنوان درباری من',
        'about_title2'     => 'عنوان درباری من',
        'instagram_address'     => 'آدرس اینستاگرام',
        'telegram_address'     => 'آدرس تلگرام',
        'whatsapp_address'     => 'آدرس واتس آپ',
        'github_address'     => 'آدرس گیت هاب',
        'linkedin_address'     => 'آدرس لینکدین',
        'work_history'     => 'تجربه کاری',
        'Number_of_customers'     => 'تعداد مشتری',
        'Number_of_projects'     => 'تعداد پروژه ها',
        'about_description'     => 'توضیحات',
        'icon'     => 'تصویر',
        'progress'     => 'پیشرفت',
        'project_count'     => 'پیشرفت',
        'tag'     => 'تگ',
        'customer'     => 'مشتری',
        'category'     => 'دسته بندی',
