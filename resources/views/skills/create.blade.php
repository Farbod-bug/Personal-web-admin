...
<form action="{{ route('skills.store') }}" enctype="multipart/form-data" method="POST" class="row gy-4 mb-4">
    @csrf
    ...
    <div class="col-md-6">
        ...
        <input name="progress" value="{{ old('progress') }}" type="text" class="form-control" />
